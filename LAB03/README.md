...
---
## LAB 1: Regression 
**สร้างโมเดลที่ "ทายอายุคน" จากรูปภาพใบหน้า โดยทดลอง 3 แบบ เพื่อเปรียบเทียบให้เห็นว่าวิธีไหนดีกว่ากัน
### 1.1 Simple Linear Regression  
### 1.2 Multiple Linear Regression  
### 1.3 Age Prediction 

## LAB 2: Classification 
**สร้างโมเดลที่ "ทายเพศคน" (ชาย/หญิง) จากรูปภาพใบหน้า — ต่างจาก LAB 1 ตรงที่ LAB 1 ทายเป็นตัวเลขต่อเนื่อง (อายุ) ส่วน LAB 2 ทายเป็นหมวดหมู่ (แค่ 2 ทางเลือก)
...
**ไม่ได้สร้างโมเดลใหม่ แต่เป็นการ "รวบรวมและวิเคราะห์" ผลลัพธ์ทั้งหมดจาก LAB 1 และ LAB 2 มาเปรียบเทียบกันในมุมมองต่างๆ เพื่อสรุปบทเรียนภาพรวมทั้งใบงาน
